...
<div class="container">
  <div class="row mt-5">
    <h2 class="text-center fst-italic">Dodavanje novog modela</h2>
  ...
  <div class="row mt-5">
    <div class="col-8 offset-2">
        <form action="./save.php" method="POST">
            <div class="row">
                <div class="col-6">
                    <select name="manufacturer" id="manufacturer" class="form-control">
                        <option value="0" disabled selected>--Izaberite proizvođača</option>
                        <?php
            ...
            <button class="form-control btn btn-success  mt-5">Sačuvaj</button>
        </form>
    </div>
  </div>
